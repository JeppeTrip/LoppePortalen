...
import { AuthorizationClient, MarketClient, MerchantClient, OrganiserClient, StallClient, StallTypeClient, UserClient } from "../services/clients"
...
export class RootStore {
    ...
    constructor(){
        ...
        this.boothStore = new BoothStore(this, null);
    }
}